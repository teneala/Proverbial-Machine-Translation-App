...
#include <string>
            ...
            
        {
            ...
            if(currentKey == hashTable[indx].hashWord )
            {
                    ...
                    
                {
                    ...
                    for(c = 0; c <= 15; c++)
                    {
                        cout << hashTable[indx].remaining[c] << endl;
                         it = find (checked.begin(), checked.end(), filter);
                        
                        if(hashTable[indx].remaining[c] == filter && it == checked.end())
                        {
                            keys++;
                      
                            it = checked.insert ( it , filter );
                            //c++;
                        }
                    }
                    ...
                    {
                        stringstream getCount(prov);
                        while(getCount >> counting) { count++;}
                            ...
                            
                            {
                                if(n->hashWord == currentKey && n != NULL)
                                {
                                    ...
                                    for(int c = 0; c <= 15; c++)
                                    {
                                        ...
                                        if(n->remaining[c] == filter && it == checked.end() )
                                        {
                                            
                                            keys++;
                                              it = checked.insert ( it , filter );
                                           /* if(currentKey == n->remaining[c])
                                            {
                                                keys--;
                                            }*/
    ...
    string house::storeProverbs(string prov, string store)
    {
        
       // provInput.open("/Users/tenealaspencer/tenealaspencer/trans4/DerivedData/trans3/Build/Products/Debug-iphonesimulator/proverbz.csv"); // opens the proverbs text file
       // equivInput.open("/Users/tenealaspencer/tenealaspencer/trans4/DerivedData/trans3/Build/Products/Debug-iphonesimulator/store.csv"); // opens the stored (English) proverbs text file
    ...
    string house::storeIngles(string prov, string store)
    {
    ...
    string house::storeStopWords(string stop)
    {
        //stopWords.open("/Users/tenealaspencer/tenealaspencer/trans4/DerivedData/trans3/Build/Products/Debug-iphonesimulator/stopwords.csv"); // open the stop words text file
    ...
    string house::storeStopIngles(string stop)
    {
        //stopWords.open("/Users/tenealaspencer/Desktop/englishStopWords.csv"); // open the stop words text file
